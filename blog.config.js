...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '40bff2390eaf43749586afdad5fabb97',
  UUID_REDIRECT: process.env.NEXT_PUBLIC_UUID_REDIRECT || false, // 是否启用 UUID 重定向功能
  ...
  GREETING_WORDS:
    ...
    'Hi，你好鸭~, 『生有熱烈, 『藏與俗常』, 欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '😈Zabanya', // 昵称
  BIO: process.env.NEXT_PUBLIC_BIO || '生有熱烈，藏與俗常', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.zabanya.space/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 前端, Vue, React, Javascript, CSS, html', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/kpl1715191173', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  // 修改文件参考：https://www.jsdelivr.com/package/npm/prismjs?tab=files&path=themes
  PRISM_THEME_PREFIX_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_PREFIX_PATH ||
    'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-coy.min.css', // 代码块默认主题
  PRISM_THEME_SWITCH: process.env.NEXT_PUBLIC_PRISM_THEME_SWITCH || true, // 是否开启浅色/深色模式代码主题切换； 开启后将显示以下两个主题
  PRISM_THEME_LIGHT_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_LIGHT_PATH ||
    'https://npm.elemecdn.com/prism-themes/themes/prism-base16-ateliersulphurpool.light.min.css', // 浅色模式主题
  PRISM_THEME_DARK_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH ||
    'https://npm.elemecdn.com/prism-themes/themes/prism-lucario.min.css', // 深色模式主题
  ...
  ALGOLIA_APP_ID: process.env.NEXT_PUBLIC_ALGOLIA_APP_ID || 'SGAJN3SU0D', // 在这里查看 https://dashboard.algolia.com/account/api-keys/
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://main--lucent-unicorn-faab38.netlify.app/.netlify/functions/twikoo', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'mtreb2sjfi', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
